...
public class ReportService {
    ...
    public ReportDto getMonthly(User user, int year, int month) {
        ...
        List<Object[]> incomeData =
                transactionRepository.sumByCategoryForMonth(user, "INCOME", year, month);
        ...
        List<Object[]> expenseData =
                transactionRepository.sumByCategoryForMonth(user, "EXPENSE", year, month);
        ...
        double totalIncome =
                income.values().stream().mapToDouble(Double::doubleValue).sum();
